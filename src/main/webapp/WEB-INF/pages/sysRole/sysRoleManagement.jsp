...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="page_title">用户角色信息列表</h3>
              </div>
            </div>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div class="pull-left">
                    ...
                    <button   class="btn btn-danger btn-sm" id="updateRole">修改权限</button>
                  </div>
              ...
              <div class="modal-body">
                <form id="demo-form3" data-parsley-validate class="form-horizontal form-label-left" method="post">
                  <div class="form-group">
                    <input type="hidden" name="rlId" id="selectId" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rlName" >用户角色名称 <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="rlName" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div id="tree_2" class="tree-demo"> </div>
                ...
                <div class="modal-body">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="rlName" name="rlName" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
    ...
    <!-- Datatables -->
    <script src="${proPath}/build/js/sysRoleTables.js"></script>
    <!-- myForms -->
    <script src="${proPath}/build/js/sysRoleForms.js"></script>
    <%--jsTree--%>
    <script src="${proPath}/build/js/jsTree.js"></script>
