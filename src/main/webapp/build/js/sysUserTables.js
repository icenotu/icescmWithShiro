        ...
        $.ajax({
            ...
            success:function (data) {
                $.each(data,function (n,value) {
                    // alert(value.rlId)
                    // alert($(":checkbox[value="+value.rlId+"]").val())
                    // $("#demo-form3").find(":checkbox[value="+value.rlId+"]").prop("checked",true);
                    $("#demo-form3").find(":checkbox[value="+value.rlId+"]").iCheck("check");
                    // alert($("#demo-form3").find(":checkbox[value=1]").is(':checked'));
                    // alert($("#demo-form3").find(":checkbox[value=2]").is(':checked'));
                })
            }
        });
...
$('#demo-form3 .btn-success').on('click', function() {
    ...
    var array = new Array();
    $("input[name='sysRoles']:checkbox").each(function() {
...
/**
 * 修改角色界面不可见时移除checkbox的checked状态
 */
